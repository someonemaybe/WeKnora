...
const MESSAGES = {
  zh: {
    ...
    needsSettings: "请先配置 ZS-HiAI API 地址和 API Key，再加载知识库。",
    openSettings: "打开设置",
    knowledgeBase: "知识库",
    tapToSelect: "点击选择",
    ...
    saveSettings: "保存设置",
    saved: "已保存",
    missingBaseUrl: "请先配置 ZS-HiAI API 地址。",
    missingApiKey: "请先配置 ZS-HiAI API Key。"
  },
  en: {
    ...
    knowledgeTitle: "ZS-HiAI Knowledge",
    knowledgeSubtitle: "Import a web page into a selected knowledge base from WeChat.",
    needsSettings: "Configure the ZS-HiAI API base URL and API key before loading knowledge bases.",
    ...
    chatSubtitle: "Ask the selected ZS-HiAI knowledge base.",
    question: "Question",
    questionPlaceholder: "Ask something...",
    askZS-HiAI: "Ask ZS-HiAI",
    answer: "Answer",
    chatFailed: "Chat failed",
    sessionIdMissing: "The session API did not return a session id.",
    settingsTitle: "Connect ZS-HiAI",
    settingsSubtitle: "Use your ZS-HiAI API endpoint and tenant API key.",
    ...
    saved: "Saved",
    missingBaseUrl: "Please configure the ZS-HiAI API base URL first.",
    missingApiKey: "Please configure the ZS-HiAI API key first."
  }
};
