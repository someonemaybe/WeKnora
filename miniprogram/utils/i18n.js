...
const MESSAGES = {
  zh: {
    ...
    needsSettings: "请先配置 HiAI API 地址和 API Key，再加载知识库。",
    openSettings: "打开设置",
    knowledgeBase: "知识库",
    tapToSelect: "点击选择",
    ...
    settingsTitle: "连接 HiAI",
    settingsSubtitle: "填写 HiAI API 地址与租户 API Key。",
    apiBaseUrl: "API 地址",
    ...
    saveSettings: "保存设置",
    saved: "已保存",
    missingBaseUrl: "请先配置 HiAI API 地址。",
    missingApiKey: "请先配置 HiAI API Key。"
  },
  en: {
    ...
    knowledgeTitle: "HiAI Knowledge",
    knowledgeSubtitle: "Import a web page into a selected knowledge base from WeChat.",
    needsSettings: "Configure the HiAI API base URL and API key before loading knowledge bases.",
    ...
    chatSubtitle: "Ask the selected HiAI knowledge base.",
    question: "Question",
    ...
    settingsTitle: "Connect HiAI",
    settingsSubtitle: "Use your HiAI API endpoint and tenant API key.",
    ...
    saved: "Saved",
    missingBaseUrl: "Please configure the HiAI API base URL first.",
    missingApiKey: "Please configure the HiAI API key first."
  }
};
