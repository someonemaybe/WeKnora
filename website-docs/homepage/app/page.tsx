      ...
      <section className={`${s.shell} ${s.hero}`} aria-labelledby="hero-title">
        ...
        <div className={s.heroGrid}>
          ...
          <div className={s.heroAside}>
            <p className={s.eyebrow}>ZS OPEN SOURCE · ZS-HIAI</p>
            <p className={s.heroDescription}>ZS 开源的企业级知识管理框架。<br />汇集团队资料，用于知识问答、任务执行和 Wiki 整理。</p>
        ...
        <ProductVideo />
        <div className={s.trustBar}><span><Icon name="github" /> ZS 开源 · MIT License</span><span><Icon name="server" /> 支持私有化部署</span><span><Icon name="model" /> 自由选择模型与存储</span></div>
      </section>
